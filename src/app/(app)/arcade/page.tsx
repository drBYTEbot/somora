  ...
  return (
    <div className="container-page py-10 lg:py-14">
      <SectionHeader
        ...
        description="Every mini-game teaches one core AI concept. Play, experiment, and level up your understanding."
        center
      />
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {arcadeGames.map((g, i) => (
            ...
            >
              ...
              <div className="relative mt-3 flex items-center gap-3 text-[10px] text-cloud-dim">
