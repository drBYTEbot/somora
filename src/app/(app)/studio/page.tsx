  ...
  return (
    <div className="container-page py-10 lg:py-14">
      <SectionHeader
        ...
        description="Real AI generates a working app you can preview live, share with a link, and save to your portfolio."
        center
      />
      ...
      {/* Main split layout: results + live preview */}
              ...
              <div className="flex min-h-[400px] items-center justify-center rounded-4xl glass p-12 text-center">
                <div>
                  ...
                  <p className="mt-1 text-sm text-cloud-dim">
                    AI is writing real HTML, CSS, and JavaScript
                  </p>
                </div>
              </div>
              <div className="flex min-h-[400px] items-center justify-center rounded-4xl glass p-12 text-center">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-sm text-cloud-dim">
            ...
            >
              ...
              <div className="space-y-4">
                <div className="relative overflow-hidden rounded-4xl glass-strong p-6">
                  ...
                  <div className="relative flex items-center gap-4">
                    <div
                      className={cn(
                        "flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br text-3xl shadow-glow-lg",
                        gradient,
                      )}
                    >
                  ...
                  <div className="relative mt-4 rounded-2xl bg-night-950/50 p-4">
                    <p className="text-xs font-semibold uppercase tracking-wider text-cloud-dim">
                      How it works
                    </p>
                ...
                <div className="rounded-4xl glass p-5">
                  <p className="mb-3 text-xs font-semibold uppercase tracking-wider text-cloud-dim">
                    What I built &amp; how each part works
                  </p>
                  <div className="space-y-2">
                    {result.components.map((c, i) => (
                      ...
                      >
                        <div
                          className={cn(
                            "flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-gradient-to-br text-xs font-bold text-night-950",
                            gradient,
                          )}
                        >
                          {i + 1}
                ...
                <div className="rounded-2xl bg-aurora-amber/10 p-4 text-sm text-aurora-amber">
                  <span className="font-semibold">Your turn:</span> This is a
                  real working app. Save it to your portfolio or share the link
              ...
              <div className="lg:sticky lg:top-20 lg:self-start">
                <div className="overflow-hidden rounded-4xl glass-strong">
                  ...
                  {showCode ? (
                    <div className="h-[500px] overflow-auto p-4">
                      <pre className="whitespace-pre-wrap break-words text-xs text-cloud-muted">
                        {result.html}
                      </pre>
                    </div>
                  ) : (
                ...
                <p className="mt-2 text-center text-xs text-cloud-dim">
                  Live preview {"\u00B7"} This is a real app running in your
                  browser
                </p>
              </div>
            </motion.div>
          ...
          {!result && !building && !error && (
            ...
            >
              <div className="rounded-4xl glass p-12 text-center">
                ...
                <p className="mt-1 text-sm text-cloud-dim">
                  Real AI will build a working app with HTML, CSS, and
                  JavaScript.
                </p>
              </div>
              <div className="rounded-4xl glass p-12 text-center">
                ...
                <p className="mt-1 text-sm text-cloud-dim">
                  See your app run instantly. Share it with a link.
                </p>
              </div>
            </motion.div>
          )}
